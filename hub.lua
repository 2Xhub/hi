...
local H = Dev:NewSection("Online")
local Main = Farm:NewSection("Main")
local M = Auto:NewSection("Item/Quets")
local Ss = Stats:NewSection("Stast")
local RaceV4 = Rac:NewSection("Race V4")
local P = Playy:NewSection("Player")
local R = Raid:NewSection("Raid")
local T = TP:NewSection("Teleport")
local S = Shop:NewSection("Shops")
local D = Dee:NewSection("Shops Fruits")
